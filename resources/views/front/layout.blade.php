...
<html lang="en">
  <head>
    ...
    {{-- this script is for getting the path where we stored oue images in that specific folder --}}
    <script>
            ...
            <div class="aa-header-bottom-area">
              ...
              <div class="aa-cartbox">
                <a class="aa-cart-link" href="#" id="cartBox">
                  ...
                  {{-- Making this data dynamic in the helper function --}}
                ...
                @if($totalCartItem > 0)
                  ...
                  <ul>
                    ...
                    <?php  $totalPrice = $totalPrice+($cartItem->qty * $cartItem->price)  ?>
                    <li>
      ...
      <div class="modal-content">                      
        ...
        <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
          ...
          <form class="aa-login-form" id="frmLogin">
            ...
            <p class="aa-lost-password"><a href="javascript:void(0)" onclick="forgot_password()" style="color: red">Lost your password?</a></p>
...
{{-- popup for forgot Password --}}
          ...
          <form class="aa-login-form" id="frmForgot">
            ...
            {{--Btn for Login Error  --}}
            <div style="clear:both"; id="forgot_msg"></div>
            <div class="aa-register-now">
